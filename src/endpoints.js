...
module.exports = function (app) {
    ...
    /* NOTE: 100% automatic */
    app.get('/automatic/:id/users/:name/:passwrd', (req, res) => {
    ...
    /* NOTE: 100% automatic */
    app.post('/automatic/admin', (req, res) => {
        ...
        entity.adminName = data.adminName;
        entity.adminAge = data.adminAge;
        if (expression)
            return res.status(201).send(entity)
        return res.status(500).send({error:'error',msg:'error'})
    })
